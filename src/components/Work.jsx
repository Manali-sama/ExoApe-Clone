          ...
          <div className="elem p-5 sm:px-32 w-full sm:flex  sm:gap-32   sm:my-40">
            ...
            <div className="w-full mt-5 h-[104vw] sm:h-[95vh] overflow-hidden relative">
              ...
              whileHover={{opacity:0}}
                ...
                className="w-full hidden  sm:absolute top-[28.5%] left-0 z-[2] sm:block object-cover h-full sm:w-[55vh] sm:h-[65vh]"
              ...
              <video
                ...
                autoPlay
                loop
                className="w-full h-full sm:w-[57vh] sm:h-[50vh]  z-[1] scale-[1.3]"
